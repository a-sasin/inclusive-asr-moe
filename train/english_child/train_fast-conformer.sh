...
CONFIG_PATH=${PROJECT_ROOT}/inclusive-asr-moe/configs/NEW/english_child
...
EXPERIMENT_ROOT=${PROJECT_ROOT}/inclusive-asr-moe/experiments/NEW/english_child/dense
