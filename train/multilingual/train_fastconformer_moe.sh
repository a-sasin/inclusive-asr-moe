...
CONFIG_PATH=${PROJECT_ROOT}/inclusive-asr-moe/configs/NEW/multilingual
...
PRETRAINED_NEMO=${PRETRAINED_NEMO:-"/lp-dev/amelia/inclusive-asr-moe/baseline_weights/stt_ml_fastconformer_ctc_large_to_moe_init.nemo"}
...
EXPERIMENT_ROOT=${PROJECT_ROOT}/inclusive-asr-moe/experiments/NEW/multilingual/moe
