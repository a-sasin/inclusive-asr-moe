...
PRETRAINED_NEMO=${PRETRAINED_NEMO:-"/lp-dev/amelia/inclusive-asr-moe/baseline_weights/stt_en_fastconformer_ctc_large_to_fast_from_config_ffreset.nemo"}
...
EXPERIMENT_ROOT=${PROJECT_ROOT}/inclusive-asr-moe/experiments/NEW/english/dense
...
echo "========================================"
echo "Dense FastConformer Training (NEW)"
echo "========================================"
