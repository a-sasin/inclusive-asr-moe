...
PRETRAINED_NEMO=${PRETRAINED_NEMO:-"${PROJECT_DIR}/experiments/NEW/multilingual/dense/dense_fastconformer_multilingual_2026-04-22_13-48-35/2026-04-22_13-48-44/checkpoints/dense_fastconformer_multilingual_2026-04-22_13-48-35.nemo"}
...
EXPERIMENT_NAME=${EXPERIMENT_NAME:-"dense_fastconformer_child_multilingual_${RUN_TAG}"}
EXPERIMENT_ROOT=${PROJECT_DIR}/experiments/multilingual/child/dense
...
echo "========================================"
echo "Dense FastConformer Child Fine-tuning (Multilingual)"
echo "========================================"
...
############################################
{
  ...
  echo "git (project):"
  (cd "${PROJECT_DIR}" && git rev-parse HEAD 2>/dev/null || true)
