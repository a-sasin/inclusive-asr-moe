...
# CUDA_VISIBLE_DEVICES=0,1,2,3 bash training/multilingual/stage3_child_moe.sh
...
EXPERIMENT_NAME=${EXPERIMENT_NAME:-"moe_fastconformer_child_multilingual_${RUN_TAG}"}
EXPERIMENT_ROOT=${PROJECT_DIR}/experiments/multilingual/child/moe
