...
PRETRAINED_NEMO=${PRETRAINED_NEMO:-"${PROJECT_DIR}/baseline_weights/stt_ml_fastconformer_ctc_large_to_fast_from_config_ffreset.nemo"}
...
EXPERIMENT_ROOT=${PROJECT_DIR}/experiments/multilingual/adult/dense
...
echo "========================================"
echo "Dense FastConformer Multilingual Training"
echo "========================================"
