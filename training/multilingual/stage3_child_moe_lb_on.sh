...
PRETRAINED_NEMO=${PRETRAINED_NEMO:-"${PROJECT_DIR}/experiments/NEW/multilingual/moe/moe_fastconformer_multilingual_2026-04-22_13-48-13/2026-04-22_13-48-26/checkpoints/moe_fastconformer_multilingual_2026-04-22_13-48-13.nemo"}

# User controls GPU routing from shell, e.g.:
# CUDA_VISIBLE_DEVICES=0,1,2,3 bash training/multilingual/stage3_child_moe_lb_on.sh
...
EXPERIMENT_NAME=${EXPERIMENT_NAME:-"moe_fastconformer_child_multilingual_load_balancing_on_${RUN_TAG}"}
EXPERIMENT_ROOT=${PROJECT_DIR}/experiments/multilingual/child/moe_lb_on
