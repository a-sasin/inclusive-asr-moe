...
CONFIG_PATH=${PROJECT_DIR}/configs/english
CONFIG_NAME=adult_moe.yaml
TOKENIZER_DIR=${PROJECT_DIR}/tokenizers/granary_en_bpe_4096/tokenizer_spe_bpe_v4096


PRETRAINED_NEMO=${PRETRAINED_NEMO:-"${PROJECT_DIR}/baseline_weights/stt_en_fastconformer_ctc_large_to_moe_init.nemo"}
...
EXPERIMENT_NAME=${EXPERIMENT_NAME:-"moe_fastconformer_librispeech_${TIMESTAMP}"}
EXPERIMENT_ROOT=${PROJECT_DIR}/experiments/english/adult/moe
