...
CONFIG_NAME=child_moe_lb_on.yaml
TOKENIZER_DIR=${PROJECT_DIR}/tokenizers/granary_en_bpe_4096/tokenizer_spe_bpe_v4096


PRETRAINED_NEMO=${PRETRAINED_NEMO:-"${PROJECT_DIR}/experiments/NEW/english/moe/moe_fastconformer_librispeech_2026-04-16_18-03-09/2026-04-16_18-03-22/checkpoints/moe_fastconformer_librispeech_2026-04-16_18-03-09.nemo"}

# User controls GPU routing from shell, e.g.:
# CUDA_VISIBLE_DEVICES=0,1,2,3 bash training/english/stage3_child_moe_lb_on.sh
...
EXPERIMENT_ROOT=${PROJECT_DIR}/experiments/english/child/moe_lb_on
...
echo "NOTE:        load_balance_loss_weight = 0.002 (enabled, from config child_moe_lb_on.yaml)"
echo ""
...
############################################
{
  ...
  echo "config: ${CONFIG_FILE}"
    echo "load_balance_loss_weight: 0.002 (enabled, from config)"
