...
PRETRAINED_NEMO=${PRETRAINED_NEMO:-"${PROJECT_DIR}/baseline_weights/stt_en_fastconformer_ctc_large_to_fast_from_config_ffreset.nemo"}
...
EXPERIMENT_NAME=${EXPERIMENT_NAME:-"dense_fastconformer_librispeech_${TIMESTAMP}"}
EXPERIMENT_ROOT=${PROJECT_DIR}/experiments/english/adult/dense
...
echo "========================================"
echo "Dense FastConformer Training"
echo "========================================"
