...
DEFAULT_MOE_CFG = "/lp-dev/amelia/inclusive-asr-moe/configs/multilingual/adult_moe.yaml"
DEFAULT_FAST_CFG = "/lp-dev/amelia/inclusive-asr-moe/configs/multilingual/adult_dense.yaml"
