#!/bin/bash
# ============================================================================
# MoE Conformer-CTC-BPE Training (English) — 4 GPU robust script
...
CONFIG_NAME=moe_ctc_bpe_english.yaml
...
EXPERIMENT_NAME="conformer_moe_en_$(date +%Y-%m-%d_%H-%M-%S)"
EXP_DIR=${PROJECT_ROOT}/experiments/MoE/${EXPERIMENT_NAME}
