...
def parse_args():
    ...
    parser.add_argument("--cache-dir", default="/lp-dev/amelia/inclusive-asr-moe/routing_outputs_en")
    ...
    parser.add_argument(
        "--yodas-yaml",
        default="/lp-dev/amelia/inclusive-asr-moe/scripts/experiments/routing_analysis/test_ood.yaml",
    )
